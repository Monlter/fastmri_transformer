...
def cli_main(args):
    ...
    train_transform = TransformerDataTransform(args.challenge, mask_func=mask, use_seed=False)
    val_transform = TransformerDataTransform(args.challenge, mask_func=mask)
    test_transform = TransformerDataTransform(args.challenge)
